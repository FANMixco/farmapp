...
namespace pillsSV.Classes
{
    class createDB
    {
        public createDB()
        {
            ...
            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new drugstores() { iddrugstore = 1, name = "Farmacia San Nicolás, Las Cascadas", address = "Centro comercial Las Cascadas, local L-110, Intersección Avenida Jerusalén y carretera Panamericana", idcity = 5, status = "I", rating = 5, latitude = 13.677721, longitude = -89.251084 });
            });

            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new drugstores() { iddrugstore = 2, name = "Farmacia las Américas, Las Palmas", address = "km 121/2 carretera al Puerto De La Libertad centr. comer. Las Palmas shopping center local nº 8", idcity = 5, status = "I", rating = 5, latitude = 13.654095, longitude = -89.280533 });
            });

            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new drugstores() { iddrugstore = 3, name = "Farmacia las Américas, Sinai", address = "29 Calle Oriente, nº 405", idcity = 6, status = "I", rating = 5, latitude = 13.712908, longitude = -89.185454 });
            });

            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new drugstores() { iddrugstore = 4, name = "Farmacia Economicas, Las Cascadas", address = "Centro comercial Las Cascadas", idcity = 5, status = "I", rating = 5, latitude = 13.677721, longitude = -89.251084 });
            });
            #endregion
            ...
            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new medDrug() { idMeddrug = 8, idmedicine = 1200, iddrugstore = 3, status = "I" });
            });

            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new medDrug() { idMeddrug = 9, idmedicine = 3, iddrugstore = 4, status = "I" });
            });

            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new medDrug() { idMeddrug = 10, idmedicine = 5, iddrugstore = 1, status = "I" });
            });

            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new medDrug() { idMeddrug = 11, idmedicine = 7, iddrugstore = 3, status = "I" });
            });

            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new medDrug() { idMeddrug = 12, idmedicine = 7, iddrugstore = 2, status = "I" });
            });

            cnn.db.RunInTransaction(() =>
            {
                cnn.db.Insert(new medDrug() { idMeddrug = 13, idmedicine = 1500, iddrugstore = 1, status = "I" });
            });
            #endregion
